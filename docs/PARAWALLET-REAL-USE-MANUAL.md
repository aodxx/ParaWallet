...
ตั้งแต่ Phase D6 ระบบผูก `receiptId` และ `receiptFileId` เข้ากับ Sale โดย backend ตรวจว่าใบเสร็จเป็นของ Tapper ผู้สร้างและอยู่ในสวนที่มีสิทธิ์ รองรับเฉพาะภาพไม่เกิน 4 MB และไม่เปิดไฟล์ Drive เป็นสาธารณะ
