...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {showReceiptForm && role === "tapper" && <ReceiptForm garden={activeGarden} agreement={agreements[0]} onClose={() => setShowReceiptForm(false)} onSaved={() => { setShowReceiptForm(false); void refresh("sales"); }} />}
