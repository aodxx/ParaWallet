...
import { Banknote, Bell, Camera, CircleDollarSign, FileDown, FileText, Leaf, Menu, Plus, Settings2, ShieldCheck, Sprout, Upload, WalletCards, X } from "lucide-react";
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {showAgreementForm && role === "owner" && <AgreementForm garden={activeGarden} onClose={() => setShowAgreementForm(false)} onSaved={() => { setShowAgreementForm(false); void refresh("agreements"); }} />}
